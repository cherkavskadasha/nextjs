    ...
    <div className="min-h-screen flex items-center justify-center p-6 bg-[#E9D0E9]">
      <div className="bg-white p-12 rounded-[2.5rem] shadow-xl shadow-purple-200/50 w-full max-w-md border border-white">
        ...
        <button
          ...
          className="w-full mb-6 flex items-center justify-center gap-3 px-6 py-3.5 bg-white border-2 border-slate-100 hover:border-slate-200 text-slate-700 font-bold rounded-2xl transition-all shadow-sm"
        >
